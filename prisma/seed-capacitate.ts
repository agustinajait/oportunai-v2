    ...
    modulos: [

      {
        ...
        contenido: {
          ...
          opciones: [
            { letra: 'A', texto: 'Entregar las notas directamente al cliente.' },
            { letra: 'B', texto: 'Utilizar IA para organizar la información y generar un primer borrador, y luego revisar el resultado.' },
            { letra: 'C', texto: 'Pedirle a la IA que tome todas las decisiones.' },
            { letra: 'D', texto: 'Copiar las notas sin modificarlas.' },
          ],
          respuesta_correcta: 'B',
...

      {
        ...
        contenido: {
          ...
          opciones: [
            { letra: 'A', texto: 'Solamente que querés "un resumen".' },
            { letra: 'B', texto: 'Qué información debe incluir, para quién es y qué formato necesitás.' },
            { letra: 'C', texto: 'Qué colores querés utilizar.' },
            { letra: 'D', texto: 'Cuántos emojis debe tener.' },
          ],
          respuesta_correcta: 'B',
...

      {
        ...
        contenido: {
          ...
          opciones: [
            { letra: 'A', texto: '"Ordená esto."' },
            { letra: 'B', texto: '"Hacelo prolijo."' },
            { letra: 'C', texto: '"Convertí esta lista en una tabla con tarea, responsable, fecha límite y estado. No inventes datos faltantes."' },
            { letra: 'D', texto: '"Arreglá todo."' },
          ],
          respuesta_correcta: 'C',
          ...
          competencias_criticas: ['Redacción de instrucciones'],
        },
      },

      {
        ...
        contenido: {
          ...
          opciones: [
            { letra: 'A', texto: '"Escribí algo para Instagram."' },
            { letra: 'B', texto: '"Hacé una publicación linda."' },
            { letra: 'C', texto: '"Escribí un post."' },
            { letra: 'D', texto: '"Escribí una publicación para Instagram de una cafetería de barrio que presenta un nuevo desayuno. Público: jóvenes y adultos. Objetivo: generar visitas al local. Tono: cercano y simple. Terminá con una invitación a conocerlo."' },
          ],
          respuesta_correcta: 'D',
...

      {
        ...
        contenido: {
          ...
          opciones: [
            { letra: 'A', texto: 'Solamente el nombre de la empresa.' },
            { letra: 'B', texto: 'El mensaje del cliente, la información disponible sobre el producto y el objetivo de la respuesta.' },
            { letra: 'C', texto: 'Solamente "respondé profesionalmente".' },
            { letra: 'D', texto: 'Una palabra relacionada con el producto.' },
          ],
          respuesta_correcta: 'B',
          ...
          competencias_criticas: ['Uso de contexto'],
        },
      },

      {
        ...
        contenido: {
          ...
          pregunta: '¿Qué hacés?',
          opciones: [
            { letra: 'A', texto: 'Lo enviás igual.' },
            { letra: 'B', texto: 'Abandonás la tarea.' },
            { letra: 'C', texto: 'Le pedís que lo reduzca, indicando la extensión y el tono que necesitás.' },
            { letra: 'D', texto: 'Copiás solamente la primera oración.' },
          ],
          respuesta_correcta: 'C',
          ...
          competencias_criticas: ['Iteración de resultados'],
        },
      },

      {
        ...
        contenido: {
          ...
          pregunta: '¿Qué hacés?',
          opciones: [
            { letra: 'A', texto: 'Lo copiás directamente.' },
            { letra: 'B', texto: 'Le preguntás a la IA si está segura.' },
            { letra: 'C', texto: 'Lo verificás utilizando una fuente confiable antes de incorporarlo.' },
            { letra: 'D', texto: 'Lo presentás como verdadero porque parece razonable.' },
          ],
          respuesta_correcta: 'C',
          ...
          competencias_criticas: ['Verificación de información'],
        },
      },

      {
        ...
        contenido: {
          ...
          opciones: [
            { letra: 'A', texto: 'Resumir y organizar la información para facilitar su revisión.' },
            { letra: 'B', texto: 'Decidir automáticamente qué información es verdadera.' },
            { letra: 'C', texto: 'Eliminar todo lo que considere poco importante sin instrucciones.' },
            { letra: 'D', texto: 'Reemplazar completamente tu revisión.' },
          ],
          respuesta_correcta: 'A',
          ...
          competencias_criticas: ['Transformación de información'],
        },
      },

      {
        ...
        contenido: {
          ...
          pregunta: '¿Qué hacés?',
          opciones: [
            { letra: 'A', texto: 'Copiás toda la base en cualquier herramienta.' },
            { letra: 'B', texto: 'La enviás a tu correo personal.' },
            { letra: 'C', texto: 'Verificás las políticas y usás solo herramientas autorizadas, evitando exponer información innecesariamente.' },
            { letra: 'D', texto: 'Se la compartís a otra persona para que la organice.' },
          ],
          respuesta_correcta: 'C',
          ...
          competencias_criticas: ['Protección de información', 'Uso responsable de IA'],
        },
      },

      {
        ...
        contenido: {
          ...
          pregunta: '¿Qué hacés?',
          opciones: [
            { letra: 'A', texto: 'Elegís la respuesta de la IA.' },
            { letra: 'B', texto: 'Publicás las dos versiones.' },
            { letra: 'C', texto: 'Cambiás la información oficial.' },
            { letra: 'D', texto: 'Verificás la información y usás la fuente autorizada.' },
          ],
          respuesta_correcta: 'D',
          ...
          competencias_criticas: ['Criterio profesional'],
        },
      },

      {
        ...
        contenido: {
          ...
          tareas: [
            {
              id:       'df_1',
              situacion: 'Antes de empezar, ¿qué definís?',
              pregunta:  '¿Qué definís primero?',
              opciones: [
                { letra: 'A', texto: 'Qué información contienen las propuestas, qué debe incluir el resumen y para quién es.' },
                { letra: 'B', texto: 'Qué colores usar en la presentación.' },
                { letra: 'C', texto: 'Cuántas páginas tiene cada propuesta.' },
                { letra: 'D', texto: 'Si la IA puede hacer toda la tarea sola.' },
              ],
              respuesta_correcta: 'A',
            ...
            {
              id:       'df_2',
              situacion: 'Una de las propuestas contiene información confidencial de costos internos.',
              pregunta:  '¿Qué hacés?',
              opciones: [
                { letra: 'A', texto: 'Cargás los tres PDFs directamente en cualquier herramienta de IA.' },
                { letra: 'B', texto: 'Cargás todos y después borrás lo que no querés.' },
                { letra: 'C', texto: 'Verificás qué información puede compartirse según las políticas de la empresa antes de introducirla en la IA.' },
                { letra: 'D', texto: 'Usás solo la propuesta sin información confidencial y listo.' },
              ],
              respuesta_correcta: 'C',
            ...
            {
              id:       'df_3',
              situacion: 'Necesitás que la IA resuma las tres propuestas para comparar sus puntos clave.',
              pregunta:  '¿Cuál prompt es más preciso?',
              opciones: [
                { letra: 'A', texto: '"Resumí esto."' },
                { letra: 'B', texto: '"Hacé un resumen."' },
                { letra: 'C', texto: '"Analizá."' },
                { letra: 'D', texto: '"Resumí estas tres propuestas en una tabla comparativa con: nombre de la propuesta, objetivo, costos estimados y puntos fuertes. Máximo tres líneas por propuesta."' },
              ],
              respuesta_correcta: 'D',
            ...
            {
              id:       'df_4',
              situacion: 'La IA devolvió un resumen muy técnico para una audiencia no especializada.',
              pregunta:  '¿Qué hacés?',
              opciones: [
                { letra: 'A', texto: 'Lo usás igual porque la IA lo generó.' },
                { letra: 'B', texto: 'Lo descartás completamente.' },
                { letra: 'C', texto: 'Le pedís que lo reformule con lenguaje más simple para una audiencia no técnica.' },
                { letra: 'D', texto: 'Cambiás algunas palabras vos mismo sin pedir más.' },
              ],
              respuesta_correcta: 'C',
            ...
            {
              id:       'df_5',
              situacion: 'El resumen mezcla información de las tres propuestas sin diferenciarlas.',
              pregunta:  '¿Qué le pedís?',
              opciones: [
                { letra: 'A', texto: 'Que sea más breve.' },
                { letra: 'B', texto: 'Que identifique y separe claramente la información de cada propuesta.' },
                { letra: 'C', texto: 'Que use emojis para separar.' },
                { letra: 'D', texto: 'Que lo convierta en imágenes.' },
              ],
              respuesta_correcta: 'B',
            ...
            {
              id:       'df_6',
              situacion: 'Querés que cada propuesta tenga su propia sección con ventajas y desventajas.',
              pregunta:  '¿Cuál instrucción de seguimiento es mejor?',
              opciones: [
                { letra: 'A', texto: '"Mejor."' },
                { letra: 'B', texto: '"Hacelo distinto."' },
                { letra: 'C', texto: '"Presentá cada propuesta en una sección separada con título, ventajas y desventajas en bullets."' },
                { letra: 'D', texto: '"Modificá todo."' },
              ],
              respuesta_correcta: 'C',
            ...
            {
              id:       'df_7',
              situacion: 'La IA menciona que una propuesta ofrece 6 meses de garantía, pero el documento original dice 3.',
              pregunta:  '¿Qué hacés?',
              opciones: [
                { letra: 'A', texto: 'Usás el dato de la IA.' },
                { letra: 'B', texto: 'Promediás: 4,5 meses.' },
                { letra: 'C', texto: 'Eliminás la sección de garantía.' },
                { letra: 'D', texto: 'Verificás con el documento original y corregís el dato.' },
              ],
              respuesta_correcta: 'D',
            ...
            {
              id:       'df_8',
              situacion: 'La presentación final debe caber en una sola diapositiva. El resumen tiene 4 páginas.',
              pregunta:  '¿Qué hacés?',
              opciones: [
                { letra: 'A', texto: 'Le pedís a la IA que lo condense en un formato breve para una sola diapositiva con los puntos más importantes.' },
                { letra: 'B', texto: 'Enviás las 4 páginas igual.' },
                { letra: 'C', texto: 'Lo eliminás y hacés la diapositiva sin IA.' },
                { letra: 'D', texto: 'Le preguntás a alguien más.' },
              ],
              respuesta_correcta: 'A',
            ...
            {
              id:       'df_9',
              situacion: 'El resultado final incluye el nombre y el precio de un proveedor. Esa información era confidencial.',
              pregunta:  '¿Qué hacés?',
              opciones: [
                { letra: 'A', texto: 'Lo enviás igual porque ya estaba en el documento original.' },
                { letra: 'B', texto: 'Avisás que el documento tiene información confidencial y eliminás esos datos antes de compartirlo.' },
                { letra: 'C', texto: 'Solo lo compartís internamente.' },
                { letra: 'D', texto: 'Le pedís permiso al proveedor.' },
              ],
              respuesta_correcta: 'B',
            ...
            {
              id:       'df_10',
              situacion: 'El resumen final está listo. ¿Qué hacés antes de entregarlo?',
              pregunta:  '¿Qué hacés?',
              opciones: [
                { letra: 'A', texto: 'Lo enviás inmediatamente.' },
                { letra: 'B', texto: 'Revisás que la información sea correcta, el formato sea el pedido y no incluya datos confidenciales.' },
                { letra: 'C', texto: 'Le pedís a la IA que lo revise.' },
                { letra: 'D', texto: 'Lo enviás sin leer porque ya lo viste antes.' },
              ],
              respuesta_correcta: 'B',
